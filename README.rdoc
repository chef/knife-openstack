...
This is the official Opscode Knife plugin for OpenStack. This plugin gives knife the ability to create, bootstrap, and manage OpenStack Compute instances.
